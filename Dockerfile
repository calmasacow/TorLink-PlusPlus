...
CMD ["sh", "-c", "mkdir -p /downloads && exec runuser -u torlink -- env HOME=/home/torlink XDG_CONFIG_HOME=/home/torlink/.config XDG_DATA_HOME=/home/torlink/.local/share node dist/index.js serve"]
